...
if (isset($_GET['id'])) {
    $patientID = $_GET['id'];
    $query = "SELECT pat.*, fam.*, c.*, r.referral_date,p.*,b.*,phy.*,
          ...
          LEFT JOIN tbl_physical_exam AS phy ON b.physical_exam_id =phy.physical_exam_id 
    ...
    <div id="print" style="max-width:850px;">
        ...
        <div style=" max-width:740px; margin-left:10rem; padding:10px; ">
            <label class="form-label">OB GYNE:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                ...
                <span>EDC:&nbsp;&nbsp;&nbsp;&nbsp;<u><?php echo htmlspecialchars($patientData['edc_by_lmp']); ?></u> </span>&nbsp;&nbsp;
                <span>AOG:&nbsp;&nbsp;&nbsp;&nbsp;<u><?php echo htmlspecialchars($patientData['aog']); ?></u> </span>&nbsp;&nbsp;
                <span>Fundic Height:&nbsp;&nbsp;&nbsp;&nbsp;<u><?php echo htmlspecialchars($patientData['presentation']); ?></u> </span>&nbsp;&nbsp;
                <br>
                <span style="margin-left: 100px;"></span>
                <span>FHT:&nbsp;&nbsp;&nbsp;&nbsp;<u><?php echo htmlspecialchars($patientData['fhb']); ?></u> </span>&nbsp;&nbsp;
                <span>GP:&nbsp;&nbsp;&nbsp;&nbsp;<u><?php echo htmlspecialchars($patientData['G']); ?></u> </span>&nbsp;&nbsp;
                <span>IE:&nbsp;&nbsp;&nbsp;&nbsp;<u><?php echo htmlspecialchars($patientData['rr']); ?></u> </span>&nbsp;&nbsp;
                <span>BOW:&nbsp;&nbsp;&nbsp;&nbsp;<u><?php echo htmlspecialchars($patientData['bow']); ?></u> </span>&nbsp;&nbsp;
            </label>
