                            ...
                            <div class="col-12">
                                <div class="card mb-4">
                                    <div class="card-header">
                                        <h5 class="card-title"> <span> <a href="checkup.php" type="button" class="btn btn-primary float-end">
                                                    ...
                                                    ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <td>
                                                                <a href="controller/viewcheckup_form.php?id=<?php echo $row['complaintID'] ?>"button class="btn btn-outline-info btn-sm" data-bs-toggle="tooltip"
