              ...
              <div class="col-12">
                <div class="card mb-4">
                  <div class="card-header">
                    <h5 class="card-title">Patient Check-up</h5>
                  </div>
                  <div class="card-body">
                  <div <div class="col-12">
                                <div class="d-flex gap-2 justify-content-end mb-2">

                                    <a href="checkup_record.php" type="button"  class="btn btn-outline-success ms-1">
                                        View Records
                                    </a>
                                </div>
                            </div>
                          ...
                          <thead>
                            <tr>
                              ...
                              $query = "SELECT users.*, family.brgy, family.purok, family.province, mem.*, complaints.*
                                  ...
                                  WHERE complaints.status = 'pending' AND complaints.consultation_purpose = 'Checkup'
